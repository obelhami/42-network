...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/07/23 16:00:42 by obelhami          #+#    #+#             */
/*   Updated: 2024/07/26 03:46:53 by obelhami         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	parsing(int argc, char **argv, t_table *table)
{
	...
	while (i < argc)
	{
		if (check_arg(argv[i]) == 0 || empty_arg(argv[i]))
		{
